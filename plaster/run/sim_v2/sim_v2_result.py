...
class SimV2Result(BaseResult):
    ...
    required_props = dict(
        params=SimV2Params,
        train_dyemat=ArrayResult,  # (n_dtrs, n_channels * n_cycles):uint8
        ...
        train_radmat=(type(None), ArrayResult),
        train_radmat_true_pep_iz=(type(None), np.ndarray),
        test_radmat=(type(None), ArrayResult),
        test_dyemat=(type(None), ArrayResult),  # For debugging
    ...
    def flat_train_radmat(self):
        assert self.train_radmat.ndim == 2
        return self.train_radmat

    def flat_test_radmat(self):
        assert self.test_radmat.ndim == 2
        return self.test_radmat
