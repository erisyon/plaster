...
def zest_sigproc_v2_calibration():
    ...
    def background_stats():
        ...
        def common_bg_stats():
            ...
            def it_subtracts_uniform_bg_mean_correctly():
                ...
                new_est_bg_mean, new_est_bg_std = worker._background_regional_estimate_im(
                    im_sub, divs
                )
            ...
            def it_estimates_nonuniform_bg_mean_correctly():
                ...
                est_bg_mean, est_bg_std = worker._background_regional_estimate_im(im_sc, divs)
            ...
            def it_estimates_nonuniform_bg_std_correctly():
                ...
                est_bg_mean, est_bg_std = worker._background_regional_estimate_im(im3, divs)
                # ESTIMATE mean and std, check that it got nonuniformity of means
                for y, x in grid_walk(divs):
                    if x in [0, divs - 1] or y in [0, divs - 1]:  # i.e. near the edge
                        assert np_within(
            ...
            def it_subtracts_nonuniform_bg_mean_correctly():
                ...
                new_mean, new_std = worker._background_regional_estimate_im(im_sub, divs)
                try:
    ...
    def psf_stats():
        ...
        def it_can_calibrate_psf_im_nonuniform():
            ...
            est_bg_mean, est_bg_std = worker._background_regional_estimate_im(img1, divs)
            ...
            est_bg_mean, est_bg_std = worker._background_regional_estimate_im(img2, divs)
